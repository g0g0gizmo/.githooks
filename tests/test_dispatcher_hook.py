"""
Tests for dispatcher.hook.

Verifies existence and execution of the dispatcher.hook script.
"""
...
HOOK_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), "../pre-commit/dispatcher.hook")).replace("\\", "/")
