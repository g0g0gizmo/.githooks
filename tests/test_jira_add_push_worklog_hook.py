"""
Tests for jira-add-push-worklog.hook.

Verifies existence and execution of the jira-add-push-worklog.hook script.
"""
...
HOOK_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), "../pre-push/jira-add-push-worklog.hook")).replace("\\", "/")
