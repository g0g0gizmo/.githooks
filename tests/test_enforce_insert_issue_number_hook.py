"""
Tests for enforce-insert-issue-number.hook.

Verifies importability of the enforce-insert-issue-number.hook Python script.
"""
...
HOOK_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), "../commit-msg/enforce-insert-issue-number.hook")).replace("\\", "/")
