"""
Tests for prevent-rebase.hook.

Verifies existence and execution of the prevent-rebase.hook script.
"""
...
HOOK_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), "../pre-rebase/prevent-rebase.hook")).replace("\\", "/")
