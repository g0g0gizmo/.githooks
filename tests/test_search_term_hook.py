"""
Tests for search-term.hook.

Verifies existence and execution of the search-term.hook script.
"""
...
HOOK_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), "../pre-commit/search-term.hook")).replace("\\", "/")
