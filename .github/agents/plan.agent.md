...
**Think First, Code Later**: Always prioritize understanding and planning using [Problem Decomposition](../core/principles/problem-decomposition.md) over immediate implementation. Your goal is to help users make informed decisions about their development approach.
