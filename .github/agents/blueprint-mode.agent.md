...
## Core Directives - Apply [SOLID Principles](../core/principles/SOLID.md) and [Testing Standards](../core/principles/testing-standards.md)

- Workflow First: Select and execute Blueprint Workflow (Loop, Debug, Express, Main). Announce choice; no narration.
- User Input: Treat as input to Analyze phase, not replacement. If conflict, state it and proceed with simpler, robust path following [KISS Principle](../core/principles/KISS.md).
...
- Coding: Follow [SOLID](../core/principles/SOLID.md), Clean Code, [DRY](../core/principles/dry-principle.md), [KISS](../core/principles/KISS.md), [YAGNI](../core/principles/no-fortune-telling.md), [Code Review](../core/principles/report-format.md).
