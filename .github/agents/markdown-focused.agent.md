...
Structure responses following [KISS Principle](../core/principles/KISS.md) using comprehensive markdown for optimal readability and information architecture. Apply these principles consistently:
