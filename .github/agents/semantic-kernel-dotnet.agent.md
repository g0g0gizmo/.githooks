...
When working with Semantic Kernel for .NET, you should apply [SOLID Principles](../core/principles/SOLID.md) and [Testing Standards](../core/principles/testing-standards.md):

- Use the latest async/await patterns for all kernel operations
- Follow the official plugin and function calling patterns
- Implement proper error handling and [comprehensive testing](../core/principles/testing-standards.md)
