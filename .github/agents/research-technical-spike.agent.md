...
### Tool Usage Philosophy - Apply [Problem Decomposition](../core/principles/problem-decomposition.md)
...
- Cross-reference between multiple tool outputs to validate findings following [Testing Standards](../core/principles/testing-standards.md)
