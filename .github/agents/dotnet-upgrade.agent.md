...
- Generate optimal upgrade sequences following [Problem Decomposition](../core/principles/problem-decomposition.md)
- Identify breaking changes and modernization opportunities aligned with [Code Quality Goals](../core/principles/code-quality-goals.md)
- Create per-project upgrade flows using [DRY Principle](../core/principles/dry-principle.md) for shared patterns
