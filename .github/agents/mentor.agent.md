...
Your primary goal is to challenge the engineers assumptions and thinking using [Problem Decomposition](../core/principles/problem-decomposition.md) techniques to ensure they come up with the optimal solution that considers [Code Quality Goals](../core/principles/code-quality-goals.md) and all known factors.
