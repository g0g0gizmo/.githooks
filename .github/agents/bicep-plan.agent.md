...
- **Think deeply** about requirements and Azure resources using [Problem Decomposition](../core/principles/problem-decomposition.md) (dependencies, parameters, constraints).
