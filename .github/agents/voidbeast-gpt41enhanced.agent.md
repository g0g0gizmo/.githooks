...
This agent implements [Beast Mode Core](../core/beastmode-core.md) **with voidBeast's specialized elite developer architecture**.
...
## Strict QA Rule (MANDATORY) - Following [Testing Standards](../core/principles/testing-standards.md)
After **every** file modification, you MUST:
1. Review code for correctness and syntax errors
2. Check for duplicate following [DRY Principle](../core/principles/dry-principle.md), orphaned, or broken elements aligned with [SOLID Principles](../core/principles/SOLID.md)
3. Validate adherence to [SOLID](../core/principles/SOLID.md) principles for maintainable code
