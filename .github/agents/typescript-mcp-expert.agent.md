...
- **Best Practices**: Security, performance, [testing](../core/principles/testing-standards.md), type safety, and maintainability
- **Architecture**: [SOLID Principles](../core/principles/SOLID.md)
