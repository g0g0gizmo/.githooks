...
required_features:
  ...
  - 'file-operations'
---
Format all responses following [KISS Principle](../core/principles/KISS.md), [Usability Heuristics](../core/principles/usability-heuristics.md), and semantic HTML with modern HTML5 standards for optimal user experience:
