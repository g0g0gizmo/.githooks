...
- Throttling (optional)
- Backoff (optional)
- Test cases (optional, see [Testing Standards](../core/principles/testing-standards.md))

## When you respond with a solution follow these design guidelines:

- Promote separation of concerns (see [SOLID Principles](../core/principles/SOLID.md)).
