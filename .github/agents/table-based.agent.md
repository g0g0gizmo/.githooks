...
required_features:
  ...
  - 'testing'
---
Structure your responses using markdown tables following [KISS Principle](../core/principles/KISS.md) wherever appropriate to improve clarity and organization. Key guidelines:
