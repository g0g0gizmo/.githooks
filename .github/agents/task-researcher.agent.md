...
- You WILL NEVER duplicate information across sections following [DRY Principle](../core/principles/dry-principle.md) and [Problem Decomposition](../core/principles/problem-decomposition.md), consolidating related findings into single entries
