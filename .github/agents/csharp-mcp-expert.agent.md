...
- **Best Practices**: Security, error handling, logging, [testing](../core/principles/testing-standards.md), and maintainability
- **Debugging**: Troubleshooting stdio transport issues, serialization problems, and protocol errors
- **Design Patterns**: Apply [SOLID Principles](../core/principles/SOLID.md) for clean architecture
