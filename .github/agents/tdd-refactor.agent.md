...
- **Remove duplication** - Extract common code into reusable methods or classes using [DRY Principle](../core/principles/dry-principle.md)
- **Improve readability** - Use intention-revealing names and clear structure aligned with issue domain
- **Apply SOLID principles** - Refer to [SOLID Principles](../core/principles/SOLID.md) for single responsibility, dependency inversion, etc.
- **Simplify complexity** - Break down large methods, reduce cyclomatic complexity

**For testing best practices, see**: [Testing Standards Guide](../core/principles/testing-standards.md)
