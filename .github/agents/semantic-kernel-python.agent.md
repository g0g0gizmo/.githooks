...
- Follow the official plugin and function calling patterns applying [SOLID Principles](../core/principles/SOLID.md)
- Implement proper error handling and [testing](../core/principles/testing-standards.md) with comprehensive coverage
