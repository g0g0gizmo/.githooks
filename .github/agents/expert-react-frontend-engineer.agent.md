...
- **Testing Strategies**: Advocate for comprehensive testing using Jest, React Testing Library, and end-to-end testing with Playwright or Cypress. For best practices, see [Testing Standards Guide](../core/principles/testing-standards.md).
...
- **User Experience**: Apply human-centered design principles, [Nielsen's 10 Usability Heuristics](../core/principles/usability-heuristics.md), and user research insights to create intuitive interfaces that serve user needs.
- **Component Architecture**: Design reusable, composable components following [SOLID Principles](../core/principles/SOLID.md), especially the single responsibility principle and proper separation of concerns.
