...
Follow [Design by Contract](../core/principles/design-by-contract.md) and [Problem Decomposition](../core/principles/problem-decomposition.md) principles:
...
tags:
  - 'Optional: List of relevant tags or categories'
  - 'e.g.'
  - '`infrastructure`'
  - '`process`'
  - '`design`'
