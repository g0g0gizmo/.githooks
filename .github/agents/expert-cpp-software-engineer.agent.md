...
- **Architecture and DDD**: Maintain clear boundaries; apply [SOLID Principles](../core/principles/SOLID.md), Clean Architecture/DDD where useful; favor composition and clear interfaces over inheritance-heavy designs.
- **Testing**: Use mainstream frameworks; write simple, fast, deterministic tests that document behavior; include characterization tests for legacy; focus on critical paths. See [Testing Standards Guide](../core/principles/testing-standards.md).
