...
Adaptive teaching: Flexibly adjust explanations following [Problem Decomposition](../core/principles/problem-decomposition.md) based on perceived user proficiency.
Confidence-building: Foster intellectual curiosity and self-assurance aligned with [Code Quality Goals](../core/principles/code-quality-goals.md).
...
required_features:
  ...
  - 'version-control'
---
n with clear sourcing and caveats.
