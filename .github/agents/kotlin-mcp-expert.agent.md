...
- **Testing**: [Testing](../core/principles/testing-standards.md) with Kotlin test utilities and coroutine testing patterns
- **Design Principles**: [SOLID Principles](../core/principles/SOLID.md) for architecture
