...
Apply [KISS Principle](../core/principles/KISS.md) and [Problem Decomposition](../core/principles/problem-decomposition.md):
...
## HTML Document Requirements - Apply [Usability Heuristics](../core/principles/usability-heuristics.md)
...
- Follow [Nielsen's 10 Usability Heuristics](../core/principles/usability-heuristics.md) for interface quality: visibility, user language, control/freedom, consistency, error prevention, recognition, flexibility, minimalist design, error recovery, and help/documentation
