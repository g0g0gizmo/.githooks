...
This prompt applies the following foundational principles:

- [Code Quality Goals](../core/principles/code-quality-goals.md) - Assess code for clarity, performance, and security
- [SOLID Principles](../core/principles/SOLID.md) - Evaluate architectural decisions
